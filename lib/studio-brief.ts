...
export type GenerationRecipe = { artworkId: string; frameId: string; colorId: string; intent: StudioIntent; instruction: string; quality?: string; background?: string; outputFormat?: string; appSetup?: AppSetup; productionItemId?: string; sceneGenerationId?:string };
